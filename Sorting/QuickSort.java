 ...
 * Best-case scenario: O(log n) as a result of balanced partitioning leading to
 * a balanced recursion tree with a call stack of size O(log n).
 * Please refer Time and Space Complexity Analysis of Quick Sort for more
 * details.
 * 
