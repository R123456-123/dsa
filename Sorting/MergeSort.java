...
public class MergeSort {
    ...
    public static void main(String[] args) {
        int[] arr = { 6, 7, 8, 9, 1, 2, 3, 4, 5, 45, 5, 68, 24, 95, 24, 65, 35, 17, 85, 12, 1, 42, 563, 56, 32, 6, 2,
                5 };
        int n = arr.length;
 ...
 * 
 * 
 * T(n) Represents the total time time taken by the algorithm to sort an array
 * of size n.
 ...
 * languages.
 * • Its variation TimSort is used in Python, Java Android and Swift. The main
 * reason why it is preferred to sort non-primitive types is stability which is
 * not there in QuickSort.
